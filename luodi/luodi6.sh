...
#一键安装脚本
#wget -O luodi6.sh https://raw.githubusercontent.com/enjack-github/easyconn/main/luodi/luodi6.sh && sudo bash luodi6.sh
#搭配中转机使用
...
function print_result_info() {
	...
	ss_str='ss://'$(echo $ss_str | base64)"@"${my_ip}":35520#luodi6"
	echo ${ss_str}
...
ufw allow ssh
ufw allow 35520
ufw delete allow 35510
ufw delete allow 9800
ufw delete allow 9900
ufw delete allow 9801
ufw delete allow 9802
ufw disable
...
echo "下载节点配置文件"
rm jiedian.json
wget -O jiedian.json https://raw.githubusercontent.com/enjack-github/easyconn/main/luodi/v2ray/config/luodi6-ss.json
